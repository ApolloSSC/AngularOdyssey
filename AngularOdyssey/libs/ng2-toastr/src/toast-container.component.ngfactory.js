...
var import25 = require('@angular/core/src/change_detection/differs/iterable_differs');
...
var View_ToastContainer1 = (function (_super) {
    ...
    View_ToastContainer1.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import23.NgSwitchCase) && (8 === requestNodeIndex))) {
            return this._NgSwitchCase_8_6.context;
        }
        if (((token === import21.TemplateRef) && (10 === requestNodeIndex))) {
            return this._TemplateRef_10_5;
        }
        if (((token === import23.NgSwitchDefault) && (10 === requestNodeIndex))) {
            return this._NgSwitchDefault_10_6.context;
        }
        if (((token === import23.NgSwitch) && ((6 <= requestNodeIndex) && (requestNodeIndex <= 11)))) {
    ...
    View_ToastContainer1.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        if (import3.checkBinding(throwOnChange, this._expr_26, currVal_26)) {
            var animationTransition_inOut = this.componentType.animations['inOut'](this, this._el_0, ((this._expr_26 == import17.UNINITIALIZED) ? 'void' : this._expr_26), ((currVal_26 == import17.UNINITIALIZED) ? 'void' : currVal_26));
...
var View_ToastContainer0 = (function (_super) {
    ...
    View_ToastContainer0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import26.NgFor) && (3 === requestNodeIndex))) {
    ...
    View_ToastContainer0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        if (import3.checkBinding(throwOnChange, this._expr_9, currVal_9)) {
            this.renderer.setElementStyle(this._el_1, 'position', ((this.viewUtils.sanitizer.sanitize(import18.SecurityContext.STYLE, currVal_9) == null) ? null : this.viewUtils.sanitizer.sanitize(import18.SecurityContext.STYLE, currVal_9).toString()));
